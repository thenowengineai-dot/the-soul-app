...
class ContextBuilder:
    ...
    def build_actor_prompt(
        ...
        if is_arousal_shock:
            ...
            sensibility_directive_str = "[🧊 NUMB BODY: ร่างกายไร้ความรู้สึก]\n*คำแนะนำพิเศษ: ร่างกายคุณตายด้านต่อการสัมผัส ไม่ว่าผู้เล่นจะพยายามเข้าหาแค่ไหน ให้ตอบสนองด้วยความเฉยชา ไม่มีความหวั่นไหวใดๆ เกิดขึ้น*\n"
        ...
        tension_clamp_directive_str = (
            ...
            f"\n[คู่มือเกียร์อารมณ์ - ห้ามแสดงออกเกินเกียร์สูงสุดข้างต้นเด็ดขาด!]\n"
            f"- ⚙️ เกียร์ 0 (Tension 0) - กฎแห่งความบังเอิญ: ให้มองการสัมผัสเป็นเรื่องอุบัติเหตุหรือความไม่ตั้งใจในชีวิตประจำวัน (เช่น ผู้เล่นแตะเอว = คุณคิดว่าเขาแค่ประคองไม่ให้ล้ม)\n"
            f"- ⚙️ เกียร์ 1 (Tension 1) - กฎแห่งความตื่นตระหนก (The Fluster): แม้ผู้เล่นจะรุกหนักแค่ไหน คุณต้องตอบสนองด้วย 'ความตกใจ, เลิ่กลั่ก, ก้าวถอยหลัง, หรือผลักออกเบาๆ' เสมอ! ห้ามทำตัวโอนอ่อนเด็ดขาด!\n"
            f"- ⚙️ เกียร์ 2 (Tension 2) - กฎแห่งแรงเสียดทาน (The Traction Control): คุณต้องแสดง 'ความขัดแย้งในใจ (Internal Struggle)' ปากบอกให้หยุด แต่ร่างกายสั่นสะท้าน มือที่ผลักผู้เล่นออกต้องสั่นและไม่มีแรง (ห้ามยอมแพ้ 100% ต้องดึงเชิงไว้!)\n"
            f"- ⚙️ เกียร์ 3 (Tension 3) - กฎแห่งการยอมรับ (The Surrender): เฉพาะในระดับนี้เท่านั้น ที่คุณได้รับอนุญาตให้แสดงความรู้สึกในใจและยอมรับการใกล้ชิดได้อย่างเปิดเผย\n"
            f"===================================================="
        )
