  ...
  if (message.type === 'vo') {
    return (
      <div className={`w-full flex justify-center px-4 select-text my-8 sm:my-10`}>
        <div className="w-full max-w-[660px] flex flex-col items-center py-2.5">
    ...
    <div className={`flex flex-col w-full ${isMe ? 'items-end' : 'items-start'} ${marginTop}`}>
      ...
      <div className={`w-full flex ${isMe ? 'justify-end' : 'justify-start'}`}>
        {isAction ? (
          ...
          <div className={`flex items-start gap-2 py-0.5 select-text my-1.5 max-w-[92%] sm:max-w-[88%] ${isMe ? 'justify-end' : 'justify-start px-1'}`}>
          ...
          <div className="relative inline-block max-w-[85%] sm:max-w-[78%]">
            <div className={`
