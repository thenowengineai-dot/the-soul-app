...
|                                                                                                                   |
|  === หมวดที่ 1: รูปลักษณ์และสไตล์ (APPEARANCE & STYLE) ===                                                               |
...
|  | [03] ปลดกระดุมเสื้อ...  |                                                                                       |
|  +------------------------+                                                                                       |
|   (The Kinematic Slide Reel)                                                                                      |
|                                                                                                                   |
|  ---------------------------------------------------------------------------------------------------------------  |
|                                                                                                                   |
|  === หมวดที่ 2: จิตวิทยาและตัวตนเบื้องลึก (MIND & SHADOW - THE GOLDEN SYMMETRICAL TRIO) ===                       |
|                                                                                                                   |
|  [ WIDGET 2.1: 2x2 (346x346) ]                                  [ WIDGET 2.2: 2x1 (346x165) ]                     |
|  +--------------------------------------------------------+     +-----------------------------------------------+ |
|  | (Sparkles) หน้ากากทางสังคม (Social Mask)               |     | (Flame) แรงขับปรารถนาสูงสุด (Core Desire)      | |
|  | ประธานบริษัทสาวผู้สุขุมเยือกเย็น ไร้ความรู้สึก...       |     | [ TACTILE PROSE TRAY ]                        | |
|  | ------------------------------------------------------ |     | ปรารถนาการยอมรับในฐานะมนุษย์ธรรมดา...         | |
|  | ✦ จุดขัดแย้งในใจ (Core Conflict Hairline)             |     +-----------------------------------------------+ |
|  | ------------------------------------------------------ |                                                       |
|  | [ INSET SHADOW TRAY ]                                  |     [ WIDGET 2.3: 2x1 (346x165) ]                     |
|  | (Skull) ตัวตนใต้เงามืด & บาดแผลในใจ (Shadow Self)      |     +-----------------------------------------------+ |
|  | ภายในแท้จริงเต็มไปด้วยความกลัวการสูญเสียอำนาจ...       |     | (Zap) จุดเปราะบาง & สิ่งที่ห้ามแตะ   < 01/03 >| |
|  +--------------------------------------------------------+     | [01] การถูกเปรียบเทียบ [02]... (+ เพิ่มจุด)   | |
|   (The Dual Persona Mirror)                                     | [ TACTILE PROSE TRAY ]                        | |
|                                                                 | เกลียดที่สุดเมื่อมีใครนำผลงานไปเปรียบเทียบ... | |
|                                                                 +-----------------------------------------------+ |
|                                                                  (Emotional Triggers Kinematic Reel)              |
+-------------------------------------------------------------------------------------------------------------------+
```
...
### 11.4 ผ่าโครงสร้างการ์ดหมวดที่ 2: จิตวิทยาและตัวตนเบื้องลึก (Mind & Shadow)

#### 🎭 Widget 2.1: กระจกสะท้อนสองมิติ (The Dual Persona Mirror) — 2x2 (346px × 346px)
- **Distance Silhouette:** **"The Split-Personality Monolith" (แท่งกระจกสะท้อนสองบุคลิก: หน้ากากด้านบน & เงามืดเบื้องล่าง)**
- **องค์ประกอบหลัก:**
  - **Upper Zone: Social Mask (หน้ากากทางสังคม):**
    - ไอคอน `Sparkles` สีส้มอำพัน `text-amber-300`
    - ป้ายหัวข้อแคปซูลขนาดกะทัดรัด `หน้ากากทางสังคม`
    - ตัวหนังสือบทบาทและบุคลิกภายนอกขนาดใหญ่ ชัดเจน มีพลัง `text-[17px] font-semibold text-white`
    - คำบรรยายบุคลิกที่แสดงต่อหน้าโลกภายนอก สีขาวเงินนวลตา
  - **The Core Conflict Hairline:**
    - เส้นแบ่งกึ่งกลาง 1px พร้อมหัวใจของความขัดแย้ง: `✦ จุดขัดแย้งในใจ (Core Conflict)`
    - ประโยคสั้นๆ ที่บอกว่าอะไรที่ทำให้สองบุคลิกนี้ต้องปะทะกันเอง
  - **Lower Zone: The Shadow Self Inset Tray (ถาดตัวตนใต้เงามืด & บาดแผลในใจ):**
    - เบาะกระจกรมควันเจาะลึก `bg-black/45 backdrop-blur-xl border border-white/[0.07] rounded-[20px]`
    - ไอคอน `Skull` หรือ `Flame` สีแดงคาร์ไมน์นุ่มลึก `text-rose-400`
    - หัวข้อ `ตัวตนใต้เงามืด & บาดแผลลึก`
    - คำบรรยายความกลัว บาดแผลในอดีต และสิ่งที่เขาพยายามปิดบังไว้อย่างมิดชิดที่สุด แสดงผลครบถ้วน 100% ไม่ถูกตัดทอน

#### 🔥 Widget 2.2: แรงขับปรารถนาสูงสุด (Core Desire) — 2x1 (346px × 165px)
- **Distance Silhouette:** **"The Primordial Drive Vessel" (ภาชนะบรรจุแรงปรารถนาแกนกลาง)**
- **องค์ประกอบหลัก:**
  - **Header Zone:** ไอคอน `Flame` สีแดงคาร์ไมน์ `text-[#EF264C]` + หัวข้อ `แรงขับปรารถนาสูงสุด`
  - **The Tactile Prose Tray:** ถาดกระจกรมควันเจาะลึกเต็มผืน แสดงข้อความความต้องการที่ลึกที่สุดของตัวละคร (สิ่งที่ขับเคลื่อนทุกการตัดสินใจและการกระทำ) ชัดเจน 100%

#### ⚡ Widget 2.3: จุดเปราะบาง & สิ่งที่ห้ามแตะ (Emotional Triggers) — 2x1 (346px × 165px)
- **Distance Silhouette:** **"The Vulnerability Slide Reel" (ม้วนฟิล์มสไลด์คิวจุดระเบิดอารมณ์)**
- **องค์ประกอบหลัก:**
  - **Header & Kinematic Navigation:** ไอคอน `Zap` สีเหลืองส้ม `text-amber-400` + หัวข้อ `จุดเปราะบาง & สิ่งที่ห้ามแตะ` พร้อมปุ่มสลับสไลด์ `< 01 / 03 >`
  - **Quick-Jump Track & Add Trigger:** ชิปตัวเลข Monospace `01`, `02` พร้อมปุ่ม `+ เพิ่มจุดเปราะบาง`
  - **The Tactile Prose Tray:** ถาดกระจกรมควันเจาะลึก แสดงคำบรรยายสิ่งที่กระตุ้นให้อารมณ์ปะทุหรือจุดอ่อนที่ทำให้เจ็บปวดที่สุด สลับอย่างนุ่มนวลด้วย Cross-fade Animation
