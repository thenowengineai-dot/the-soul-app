...
|  +--------------------------------------------------------+                                                       |
|  | จิตวิทยาและสองขั้วอารมณ์ (3 มิติ)               (Edit) |                                                       |
|  | ====================================================== |                                                       |
...
#### 🏛️ Widget 2: จิตวิทยาและสองขั้วอารมณ์ (The 3-Tier Glass Chamber) — 2x2 (`346px × 346px` Single Master Card)
- **Distance Silhouette:** **"The Tri-Symbol Persona Chamber" (แท่นจิตวิทยาสามชั้นในขนาดมาตรฐาน 2x2 พร้อมลูกแก้วไอคอน 3 ดวงเรืองแสงนวลตา)**
...
- **องค์ประกอบหลัก 3 ชั้น (The 3 Tactile Glass Tiers ในถาดกระจกรมควันเดียว):**
  1. **🛡️ Tier 1: หน้ากากทางสังคม (The Mask):**
     - **Icon Orb:** วงกลมลูกแก้วกระจกฝ้าทรง Tactile Orb 32px สีกระจกเงินฟ้าคราม `bg-cyan-500/10 text-cyan-400 border border-cyan-400/25 shadow-[0_0_10px_rgba(34,211,238,0.15)]`
  ...
  2. **⚡ Tier 2: จุดขัดแย้งในใจ (The Conflict):**
     - **Icon Orb:** วงกลมลูกแก้วกระจกฝ้าทรง Tactile Orb 32px สีกระจกส้มอำพัน `bg-amber-500/10 text-amber-400 border border-amber-400/25 shadow-[0_0_10px_rgba(251,191,36,0.15)]`
  ...
  3. **❤️ Tier 3: ธาตุแท้ใต้หน้ากาก (The Core):**
     - **Icon Orb:** วงกลมลูกแก้วกระจกฝ้าทรง Tactile Orb 32px สีกระจกชมพูแดงกุหลาบ `bg-rose-500/10 text-rose-400 border border-rose-400/25 shadow-[0_0_10px_rgba(244,63,94,0.18)]`
