...
function CharacterHud({ data, isOpen, onClose }: CharacterHudProps) {
  ...
  return (
    <>
      ...
      <aside 
        className={`h-full flex-shrink-0 flex flex-col bg-[#090909] border-l border-[#2F3336] select-none overflow-hidden transition-all duration-300 fixed inset-y-0 right-0 z-50 shadow-2xl lg:relative lg:z-10 lg:shadow-none max-w-[92vw] ${
