...
- **Distance Silhouette:** **"The Cinematic Beat Widget" (การ์ดสี่เหลี่ยมจัตุรัส Apple Jony Ive Minimal ที่มองเห็นสถานะจังหวะดราม่าชัดเจนจากระยะไกล ด้วยป้ายชื่อบีตและมาตรวัดจุดไฟไข่ปลา `โควตา: 3 รอบ ●●○`)**
...
- **Approach 1 Wording Architecture (สถาปัตยกรรมภาษาคน: ถ้าทำ... ถ้าไม่ทำ...):**
  1. **`1. 🎭 ตัวละครกำลังทำอะไร` (Actor's Strike / State):**
     - แสดงภาษากาย สรีระ เสื้อผ้า และการกระทำที่ตัวละครลงมือทำเพื่อเปิดจังหวะหรือปล่อยดาเมจใส่ผู้เล่น
  2. **`2. 🎯 ถ้าผู้เล่นทำแบบนี้ (เรื่องจะไปต่อทันที)` (Player Trigger Action):**
     - แสดงการกระทำหรือคำพูดของผู้เล่นที่ถ้าทำ จะปลดล็อกการดำเนินเรื่องทันที พร้อมป้ายกำกับ `[ → ไปต่อ ]` สีแดงคาร์ไมน์
  3. **`3. ⏳ ถ้าผู้เล่นไม่ทำอะไร (คุยครบ X รอบ เรื่องจะเดินต่อเองว่า)` (Inevitable Fate / Timeout Consequence):**
     - กรอบไฮไลต์สีอำพันนุ่มลึก แสดงแผนสองอัตโนมัติที่ตัวละครหรือโลกจะผลักดันเรื่องไปข้างหน้าเองเมื่อครบโควตาคุยเล่น
- **Rhythm Header & Turn Gauge:**
  - แถบป้ายกำกับด้านขวาบนแสดง **`โควตา: X รอบ ●●○`** ด้วยจุดไฟ Apple Gauge ที่มองไกลๆ รู้ได้ทันทีว่าบีตนี้หน่วงเวลาไว้กี่เทิร์น
- **Beat Selector Pill Dock:**
  - แถบแคปซูลด้านบน `[ ✦ บีต 1 ] [ ✦ บีต 2 ] [ ＋ ]` สำหรับสลับดูและแก้ไขบีตทั้งหมดในฉากนั้นได้อย่างลื่นไหล
- **Direct Manipulation / In-Place Edit Mode:**
  - แตะปุ่มดินสอขวาบนเพื่อเข้าสู่โหมดแก้ไข สามารถปรับชื่อบีต, โควตาเทิร์น, การกระทำของตัวละคร, ทางเลือกผู้เล่น, และเหตุการณ์อัตโนมัติ แล้วกดเครื่องหมายถูกเพื่อบันทึกลง Draft ทันที
