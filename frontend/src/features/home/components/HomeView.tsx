...
function HomeView({ 
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden no-scrollbar relative z-10 bg-[rgb(13,13,13)] backdrop-blur-xl overscroll-contain">
