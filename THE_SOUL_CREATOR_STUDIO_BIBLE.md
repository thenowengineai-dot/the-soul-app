...
#### 🎬 Card W1: ปฐมบทภาพยนตร์และสภาพแวดล้อม (Cinematic World Plaque) — 2x2 (`346px × 346px`)
- **Distance Silhouette:** **"The Cinematic World Plaque & Ambient Atmosphere Tray" (แผ่นป้ายจารึกชื่อโลกขนาดใหญ่ ขนาบด้วยเส้นขอบฟ้า Horizon Hairline และถาดผัสสะบรรยากาศ 3 มิติ)**
  - ถอดแบบดีไซน์และความสง่างามมาจาก Card 1 (Identity & Soul): ตัวหนังสือชื่อเรื่องใหญ่ทรงพลัง ปราศจากป้ายหัวข้อรกตา และตัดแถบฟุตเตอร์ด้านล่างออก
- **Layout & Visual Hierarchy:**
  - **Top Bar (Apple Tactile Circular Action):** ปราศจากป้ายหัวข้อ Category Badge คงไว้เฉพาะปุ่มดินสอกระจกฝ้าทรงกลมชิดขวาบน
  - **Masthead Hero Title (เหมือนการ์ดชื่อตัวละคร):**
    - ชื่อภาษาไทย: ขนาดใหญ่ ทรงพลัง คมชัด `text-[22px] sm:text-[24px]` หนา `font-bold` สีขาวนวลตา `#F1F1F1`
  ...
  - **Horizon Hairline Gradient (เส้นขอบฟ้าใต้ชื่อเรื่อง):**
    - เส้นคั่น 1px เกรเดียนท์ละลายสองข้าง: `bg-gradient-to-r from-transparent via-white/[0.16] to-transparent my-2.5`
  - **Ambient Weather & Mood Tray (ถาดสภาพอากาศและผัสสะบรรยากาศ 3 มิติ):**
    - บรรจุในถาดกระจกฝ้าทรงมน `rounded-2xl bg-white/[0.035] border border-white/[0.07] px-3 py-2`:
      - 🔴 **สภาพอากาศ:** แดดยามบ่ายเงียบสงัด ก่อนเมฆดำทะมึนจะกลืนทิวเขา
      - 🟡 **ผัสสะฉาก:** ไอหมอกกำมะถันออนเซ็น ปะทะ ลมหนาวชื้นกลางป่าสน
      - 🟢 **โทนสีหลัก:** เขียวมรกตพฤกษศาสตร์ตัดแดงคาร์ไมน์พิษร้อน
  - **Cinematic Premise / Logline (แก่นเรื่องย่อ 1-2 ย่อหน้าภาพยนตร์บอกเล่าสเกลเรื่อง):**
    - เนื้อหาจริง: *"ทริปเก็บกู้สมุนไพรของชมรมพฤกษศาสตร์ ณ เรียวกังออนเซ็นกลางหุบเขาที่ดูสงบเงียบ ควรจะเป็นช่วงเวลาแห่งการพักผ่อน แต่เมื่อเมฆฝนดำทะมึนเริ่มปิดล้อมป่า ละอองเกสรพิษกำเริบ และสติของรุ่นพี่สาวแว่นเริ่มหลุดลอย [PLAYER] กำลังจะถูกเหวี่ยงเข้าไปอยู่ในสถานการณ์ที่ไม่มีทางถอยกลับ..."*
    - ขนาด `text-[12px] sm:text-[12.5px]`, สีเงินแสงจันทร์ `#D6D6DC`, ระยะบรรทัด `leading-[19.5px]`, สโครลอ่านได้อย่างลื่นไหล
  - **Clean Bottom (ตัดฟุตเตอร์ล่างออก):** คืน Breathing Space ให้ตัวหนังสือบทนำหายใจได้เต็มที่ 100%
  - **Zero "โลกใบใหม่" Policy:** กำจัดข้อความ Fallback โลกใบใหม่ออกจากระบบทั้งหมด เพื่อความสมจริงของโลกที่สร้าง
- **Direct Manipulation / In-Place Edit Mode:**
  - ปุ่มดินสอขวาบน แตะเพื่อสลับเข้าโหมดแก้ไขชื่อไทย, ชื่ออังกฤษ, สภาพอากาศ, ผัสสะฉาก, โทนสีหลัก, และแก่นเรื่องย่อภาพยนตร์ แล้วกดบันทึกลง State ทันที
