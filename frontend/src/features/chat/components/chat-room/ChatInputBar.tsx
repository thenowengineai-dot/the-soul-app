...
export function ChatInputBar({
  ...
  return (
    <div 
      data-no-advance 
      className="sticky bottom-0 z-20 w-full pt-2 pb-4 sm:pb-5 mt-auto bg-gradient-to-t from-[#161618] via-[#161618]/95 to-transparent pointer-events-none"
    >
      <div className="w-full max-w-[740px] mx-auto px-4 sm:px-6 relative pointer-events-auto">
        ...
        {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            Input Bar with Standalone Front (+) Button (Balanced Dark Dock: #252528)
            ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
          ...
          >
            ...
            {hasText ? (
              <button 
                ...
                disabled={isStreaming}
                title="ส่งข้อความ"
                className={`w-[40px] h-[40px] sm:w-[42px] sm:h-[42px] rounded-full bg-gradient-to-br from-[#ff0030] to-[#ea0063] border border-white/20 text-white flex items-center justify-center hover:brightness-105 active:scale-95 transition-all shrink-0 cursor-pointer shadow-[inset_0_1.5px_0_rgba(255,255,255,0.4),0_2px_8px_rgba(0,0,0,0.3)] ${
