...
|  ---------------------------------------------------------------------------------------------------------------  |
|                                                                                                                   |
|  === หมวดที่ 2: จิตวิทยาและตัวตนเบื้องลึก (MIND & SHADOW - THE 3-TIER GLASS CHAMBER) ===                        |
|                                                                                                                   |
|  [ WIDGET 2: 4x2 (708x346) SINGLE MASTER CARD ]                                                                   |
|  +-------------------------------------------------------------------------------------------------------------+ |
|  | ✦ จิตวิทยาและสองขั้วอารมณ์ (Duality Architecture)                                                    (Edit) | |
|  | =========================================================================================================== | |
|  | [ 🛡️ THE MASK ]      หน้ากากทางสังคม                                                                        | |
|  |  (Cyan Orb)          รุ่นพี่สาวแว่นผู้มีการศึกษา พูดจาสุภาพเรียบร้อยเหนียมอาย สวมเสื้อผ้าหนาเตอะ...           | |
|  | ----------------------------------------------------------------------------------------------------------- | |
|  | [ ⚡ THE CONFLICT ]  จุดขัดแย้งในใจ                                                                         | |
|  |  (Amber Orb)         การต่อสู้ระหว่างสามัญสำนึกของรุ่นพี่ผู้มีการศึกษา กับสัญชาตญาณความต้องการทางเพศ...      | |
|  | ----------------------------------------------------------------------------------------------------------- | |
|  | [ ❤️ THE CORE ]      ธาตุแท้ใต้หน้ากาก                                                                      | |
|  |  (Carmine Orb)       นักล่ากามารมณ์จอมวางแผนผู้มีความต้องการสูงลิ่ว ใช้ทฤษฎีวิชาการมาบิดเบือนเป็นข้ออ้าง...   | |
|  +-------------------------------------------------------------------------------------------------------------+ |
|   (The 3-Tier Glass Chamber — 1 Master Card for Complete Psychology Duality)                                      |
+-------------------------------------------------------------------------------------------------------------------+
```
...
### 11.4 ผ่าโครงสร้างการ์ดหมวดที่ 2: จิตวิทยาและตัวตนเบื้องลึก (Mind & Shadow — The 3-Tier Glass Chamber)

#### 🏛️ Widget 2: จิตวิทยาและสองขั้วอารมณ์ (The 3-Tier Glass Chamber) — 4x2 (`708px × 346px` Single Master Card)
- **Distance Silhouette:** **"The Tri-Symbol Persona Chamber" (ห้องทดลองจิตวิทยาสามชั้น พร้อมเสาไอคอน 3 ดวงเรืองแสงนวลตา)**
- **ปรัชญา Subtractive & Data Truth 100%:** ยุบรวมจิตวิทยาทั้งหมดไว้ในการ์ดใหญ่เพียงใบเดียว ไม่แตกเป็นเศษการ์ดย่อย ตรงตามก้อนข้อมูลจริงในระบบ (`the_mask`, `the_conflict`, `the_core`)
- **องค์ประกอบหลัก 3 ชั้น (The 3 Tactile Glass Tiers):**
  1. **🛡️ Tier 1: หน้ากากทางสังคม (The Mask):**
     - **Icon Orb:** วงกลมลูกแก้วกระจกฝ้าทรง Tactile Orb 42px สีกระจกเงินฟ้าคราม `bg-cyan-500/10 text-cyan-400 border border-cyan-400/25 shadow-[0_0_14px_rgba(34,211,238,0.15)]`
  ...
  2. **⚡ Tier 2: จุดขัดแย้งในใจ (The Conflict):**
     - **Icon Orb:** วงกลมลูกแก้วกระจกฝ้าทรง Tactile Orb 42px สีกระจกส้มอำพัน `bg-amber-500/10 text-amber-400 border border-amber-400/25 shadow-[0_0_14px_rgba(251,191,36,0.15)]`
  ...
  3. **❤️ Tier 3: ธาตุแท้ใต้หน้ากาก (The Core):**
     - **Icon Orb:** วงกลมลูกแก้วกระจกฝ้าทรง Tactile Orb 42px สีกระจกแดงคาร์ไมน์นุ่มลึก `bg-[#EF264C]/10 text-[#EF264C] border border-[#EF264C]/25 shadow-[0_0_14px_rgba(239,38,76,0.20)]`
