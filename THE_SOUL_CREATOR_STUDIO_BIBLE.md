...
#### 📜 Card W2: บทนำ (Cinematic Prologue) — 2x2 (`346px × 346px`)
- **Distance Silhouette:** **"The Cinematic Narrative Plaque" (แผ่นจารึกบทนำภาพยนตร์สไตล์แผ่นสคริปต์ฮอลลีวูด)**
  - ใช้ขนาดมาตรฐาน **2x2 (`346px × 346px`)** ตามหลัก Lego Symmetrical Math ประกบข้าง Card W1 และ Card W3 ได้สนิท 100%
- **Layout & Visual Hierarchy:**
  ...
  - **Cinematic Narrative Prose:**
    - ข้อความจัดเรียงเต็มความกว้าง 346px บนความสูง 346px อย่างสบายตา: `text-[12.5px] sm:text-[13px] text-[#EDEDED] leading-[22px] tracking-tight`
    - สโครลเลื่อนอ่านได้อย่างลื่นไหล (`overflow-y-auto custom-scrollbar`) พร้อม Affordance บรรทัดถัดไปแบบ Peeking
  - **Zero Fake Meta:** ตัดแถบสถานะหลอกตาออกทั้งหมดตามปรัชญา Apple
- **Direct Manipulation / In-Place Edit Mode:**
  - ปุ่มดินสอขวาบน แตะเพื่อเปิดฟอร์ม Textarea แก้ไขบทบรรยายเปิดโลก แล้วกดบันทึกอัปเดตลง `draft.prologue.premise` ทันที

---

#### 🎭 Card W3: เวทีสถานที่ (The Deep-Dive Stage Card) — 2x2 (`346px × 346px`)
- **Distance Silhouette:** **"The Deep-Dive Stage Card" (การ์ดเวที 3 มิติฉบับสมบูรณ์ ถอดแบบสถาปัตยกรรมมาจาก 'ตัวตนเบื้องลึก' MindShadowCard รวม 5 มิติไว้ในการ์ด 2x2 ใบเดียว)**
  - 1 สถานที่บรรจุอยู่ในการ์ด 2x2 ใบเดียวอย่างเป็นเอกเทศ ไม่ต้องแยกเป็นสองการ์ดให้กระจัดกระจาย
- **3-Layer Chamber Architecture:**
  1. **Layer 1: Master Scene Selector Pill Dock:**
     - แถบสลับสถานที่สำคัญด้านบน สโครลเรียบลื่น: `[ 🌿 ห้องสกัดสมุนไพร ]`, `[ ♨️ บ่อออนเซ็นหิน ]`, `[ 🛖 เพิงหลบฝน ]`, `[ + เพิ่มฉาก ]`
  2. **Layer 2: The 5-Dimension Navigation Tabs:**
     - แถบแท็บ 5 มิติแนวนอน กะทัดรัด คมชัด พร้อมไอคอนและสีประจำมิติ:
       - `[ 📐 ผังห้อง ]` (`#38BDF8` Sky): สเกลห้อง ขอบเขต และจุดปักหลักทางกายภาพ
       - `[ 🎒 พร็อพ ]` (`#34D399` Emerald): วัตถุและสิ่งของที่หยิบจับได้
       - `[ 💡 แสงเงา ]` (`#FBBF24` Amber): แสงสว่าง เงามืด และทัศนวิสัย
       - `[ ♨️ ผัสสะ ]` (`#FB7185` Rose): ผัสสะรอบทิศ (กลิ่น • เสียง • สัมผัส)
       - `[ ⚡ ไดนามิก ]` (`#A78BFA` Violet): ไดนามิกของฉากและเงื่อนไขเวลา
  3. **Layer 3: Full-Bleed Dimension Chamber:**
     - เมื่อแตะเลือกมิติใด มิตินั้นจะ **กางเนื้อหาเต็มผืนการ์ดทันที** มีพื้นที่สูงถึง ~180–200px
     - บรรยายข้อความยาว 5–8 บรรทัดได้อย่างเต็มอิ่ม สบายตา พร้อมสโครลอ่าน (`overflow-y-auto custom-scrollbar`) ไร้การตัดทอน
     - แสดงชิปสัมผัสหรือรายการ bullet อย่างมีระดับตามสไตล์ Apple
- **Direct Manipulation / In-Place Edit Mode:**
  - แตะปุ่มดินสอขวาบนเพื่อเข้าสู่โหมดแก้ไข สามารถสลับแท็บเพื่อพิมพ์แก้แต่ละมิติได้อย่างอิสระ แล้วกดเครื่องหมายถูกเพื่อบันทึกลง `draft.real_locations[currentLocKey]` ทันที

---

#### 🎬 Card W4: จังหวะเรื่องและเหตุการณ์ (The Cinematic Beat Widget) — 2x2 (`346px × 346px`)
- **Distance Silhouette:** **"The Cinematic Beat Widget" (การ์ดสี่เหลี่ยมจัตุรัส Apple Jony Ive Minimal ที่มองเห็นสถานะจังหวะดราม่าชัดเจนจากระยะไกล ด้วยป้ายชื่อบีตและมาตรวัดจุดไฟไข่ปลา `โควตา: 3 รอบ ●●○` พร้อมปุ่มลูกศรแดง Red Expand Orb ขอบล่าง)**
  - รูปทรงสี่เหลี่ยมจัตุรัส 2x2 ขนาด **`346px × 346px`** ประกบเคียงข้าง Card W1, W2, W3 ใน Bento Suite ได้อย่างไร้รอยต่อ
- **The Red Expand Orb (ปุ่มลูกศรลงสีแดงยืดการ์ดอ่านเต็มความยาวจริง):**
  - ปุ่มวงกลม 28px ขอบแดงคาร์ไมน์ `#EF264C` ชวนกดตรงกึ่งกลางขอบล่างของการ์ด
  - **โหมดพับ (Compact 2x2):** ความสูงล็อก 346px เข้าชุด Bento Grid หัวข้อย่อด้วย `...` (เช่น `2. ถ้าผู้เล่นทำแบบนี้...` และ `3. ถ้าผู้เล่นไม่ทำอะไร...`) เพื่อประหยัดพื้นที่แนวตั้ง
  - **โหมดกางออก (Expanded Unfold):** การ์ดยืดลงด้านล่าง (`min-h-[346px] h-auto`) ปลดล็อกข้อความทุกกล่องทั้งสรีระตัวละคร ทุกทางเลือก และเหตุการณ์บังคับ แสดงผลเต็ม 100% ไร้การตัดทอน ไร้ `line-clamp` พร้อมลูกศรพลิกชี้ขึ้น `ChevronUp` เพื่อพับเก็บ
- **Zero VO Subtractive Policy (Default = No VO):**
  - ตัดกล่อง VO ออกจากการ์ดบีตอย่างเด็ดขาด คืนพื้นที่อันมีค่าให้กับการกระทำและผลลัพธ์ของตัวละคร
- **Multiple Triggers & The Semantic Result Engine (`→ ไปต่อ` VS `↺ อยู่ที่เดิม`):**
  - รองรับการเพิ่มทางเลือกของผู้เล่นได้ไม่จำกัด พร้อมปุ่ม `[ ＋ เพิ่มทางเลือก ]`
  - แต่ละทางเลือกสามารถกำหนดผลลัพธ์ผ่าน Dropdown ได้อย่างเป็นธรรมชาติ:
    - **`[ → ไปต่อ ]` (Progress):** เมื่อผู้เล่นทำสิ่งนี้ จะปลดล็อกการดำเนินเรื่องสู่บีตถัดไปทันที (แท็กสีแดงคาร์ไมน์)
    - **`[ ↺ อยู่ที่เดิม ]` (Loop / Holding):** ตัวละครตอบสนอง นับเทิร์นเพิ่ม แต่ยังคงอยู่ในบีตเดิมเพื่อหยั่งเชิงหรือคุยเล่น (แท็กสีอำพัน)
- **Beat Selector Pill Dock (Reorder Controls & Mid-Pill Insertion):**
  - **Mid-Pill Insertion `[ ＋ ]`:** ปุ่มบวกจิ๋วคั่นกลางระหว่างชิปบีตทุกตัว สำหรับแทรกบีตใหม่ลงตรงกลางระหว่างบีต 1 และบีต 2 ได้ทันที
  - **Reorder Arrows `◀` `▶`:** ปุ่มลูกศรซ้าย-ขวาปรากฏบน Active Beat Pill ทำให้ผู้สร้างสามารถสลับลำดับคิวบีตหน้า-หลังได้อิสระโดยไม่ต้องลบสร้างใหม่
- **Direct Manipulation / In-Place Edit Mode:**
  - แตะปุ่มดินสอขวาบนเพื่อเข้าสู่โหมดแก้ไข สามารถปรับชื่อบีต, โควตาเทิร์น, การกระทำของตัวละคร, เพิ่ม-ลบทางเลือกพร้อมกำหนด ไปต่อ/อยู่ที่เดิม, และเหตุการณ์อัตโนมัติ แล้วกดเครื่องหมายถูกเพื่อบันทึกลง Draft ทันที

---

### 12.4 Infinite Railroad Canvas Architecture (ผืนผ้ารางรถไฟเหตุการณ์สไตล์ n8n & Blender)
ผืนผ้าใบอนันต์สำหรับสร้างและควบคุมเส้นทางเรื่องราว (Story Scenario Railroad) ที่ผสมผสานความยืดหยุ่นของ Node Graph เข้ากับความกะทัดรัดอ่านง่ายของ Compound Frame:

1. **ผืนผ้าใบอนันต์และการแพน-ซูม (Infinite Pan & Zoom Canvas):**
   - **Physics & Navigation:** รองรับการลากเลื่อนฉาก (Pan / Middle-click / Drag-on-canvas) และการซูม (Zoom 40% – 150%) ผ่านลูกกลิ้งเมาส์หรือท่าทาง Trackpad
   - **Dot Grid Matrix Backdrop:** พื้นหลังตารางจุดระดับพรีเมียม `#1A1A1E` บนผืนผ้าใบ `#0F0F12` ให้มิติอวกาศลึกแต่ถนอมสายตา
   - **HUD Control Dock:** แถบลอยด้านล่างสไตล์ Apple Frosted Glass ประกอบด้วยปุ่มเพิ่มฉาก (`[ ＋ เพิ่มฉากใหม่ ]`), ปุ่มซูมเข้า/ออก (`ZoomIn`, `ZoomOut`), ปุ่มรีเซ็ตมุมมอง (`100%`), และตัวนับจำนวนฉากทั้งหมด

2. **โมเดลเฟรมรวมศูนย์ (Compound Frame Architecture) — สยบปัญหาสายระโยงระยาง (Anti-Spaghetti):**
   - **หลักการออกแบบ:** การปล่อยให้แต่ละ Beat ย่อยลอยเคว้งและโยงสายข้ามไปมาแบบอิสระจะก่อให้เกิด Spaghetti Nodes ที่อ่านไม่ออก
   - **1 ซีน = 1 สถานที่ (Scene-Location Binding Socket):** รวมกลุ่ม Beat ย่อยที่เกิดขึ้นในสถานที่เดียวกันไว้ภายใต้กรอบการ์ด Scene เดียวกัน
   - **รางรถไฟเชื่อมต่อระหว่างฉาก (Scene-to-Scene Rail Cables):** เส้น Bezier SVG สีแดงคาร์ไมน์เชื่อมต่อเฉพาะทางออกของฉาก A ไปยังทางเข้าของฉาก B อย่างคมชัดสง่างาม
   - **ปุ่มแทรกฉากกึ่งกลางราง (Mid-Cable Insertion):** มีปุ่มลอย `[ ＋ ]` บนเส้นรางกึ่งกลางระหว่าง 2 ฉาก เมื่อกดจะแทรกฉากใหม่ลงตรงกลางระหว่างฉาก A และ B ทันที พร้อมปรับตำแหน่งโหนดถัดไปให้โดยอัตโนมัติ

3. **การ์ดโหนดฉาก (Scene Node Card):**
   - **ขนาดและดีไซน์:** กว้าง 380px ขอบมนลึก `rounded-[24px]` พื้นหลังกระจกดำเงียบสงบ `#141419/95` ขอบตัด 1px `border-white/12`
   - **Draggable Header:** แถบหัวการ์ดพร้อมไอคอน Grip สำหรับจับลากย้ายตำแหน่งอย่างอิสระบน Canvas โดยคำนวณการเคลื่อนที่ตามสเกลซูม (`(clientX - startX) / zoom`) ป้องกันอาการกระตุก
   - **ช่องสวมสถานที่ 5 มิติ (Location Socket):** แถบเลือกสถานที่ที่เชื่อมต่อกับ `draft.real_locations` ทำให้ผู้สร้างสามารถสลับและเจาะลึก 5 มิติของฉากนั้นได้ทันที
   - **Rail Connector Ports:** พอร์ตเชื่อมต่อรางด้านซ้าย (Input Port) และขวา (Output Port) สไตล์สตูดิโอระดับมืออาชีพ

4. **สแตกบีตย่อยและการแทรกแบบเรียลไทม์ (Beat Stack & Instant Mid-Beat Insertion):**
   - **Vertical Chronology:** บีตย่อยเรียงตัวในแนวตั้งภายในตัวการ์ดฉาก แสดงไดเรกเตอร์เซ็ตอัป (Director Setup), ท่าทางและการตอบสนองของตัวละคร (Actor State), และระบบคุมจังหวะ (Pacing Control)
   - **ปุ่มแทรกบีตกึ่งกลาง (`[ ＋ แทรกบีต ]`):** แทรกอยู่ระหว่างบีตทุกตัวในสแตก ช่วยให้นักเขียนสามารถเติมปฏิกิริยาหรือจุดหักมุมใหม่ลงตรงกลางเรื่องราวได้อย่างแม่นยำ
   - **In-Place Inline Editor:** คลิกเพื่อแก้ไขข้อความ เกณฑ์การผ่าน (Evaluation Criteria) และจำนวนเทิร์นสูงสุดได้ทันทีโดยไม่ต้องเปิด Modal ซ้อน

---

### 12.5 สิ่งที่ต้องหลีกเลี่ยงโดยเด็ดขาด (Anti-Patterns Checklist)
...
❌ **ห้ามปล่อยให้โหนดบีตย่อยลอยเคว้ง (Spaghetti Beat Nodes):** ต้องจัดกลุ่มให้อยู่ในกรอบ Compound Scene Node เท่านั้น  
