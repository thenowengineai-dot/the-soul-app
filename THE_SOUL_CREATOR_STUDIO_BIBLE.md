...
- **Distance Silhouette:** **"The Cinematic Narrative Strip" (แถบจารึกบทนำภาพยนตร์สไตล์แผ่นสคริปต์ฮอลลีวูด)**
  - ใช้ขนาด **2x1 (`346px × 165px`)** ตามหลัก Lego Symmetrical Math ประกบข้าง Card W1 และซ้อนคู่กับ Card W3 ด้านล่างได้สนิท 100%
- **Layout & Visual Hierarchy:**
...
#### 🗺️ Card W3: ผังฉากและจุดปักหลัก (Spatial Enclosure & Anchor Points) — 2x1 (`346px × 165px`)
- **Distance Silhouette:** **"The Tactile Spatial Enclosure" (ถาดผังอาณาเขตทางกายภาพและจุดปักหลัก)**
  - วาง **ซ้อนใต้ Card W2 (บทนำ)** พอดีเป๊ะ รวมกันเป็นความสูง `165px + 16px (gap) + 165px = 346px` กลายเป็นเสา 2x2 สมบูรณ์แบบ
- **Layout & Visual Hierarchy:**
  - **Header Row:** หัวข้อชิดซ้ายคลีน **`ผังฉากและจุดปักหลัก`** พร้อมวงเล็บชื่อสถานที่ปัจจุบันจางๆ เช่น `(ห้องสกัดสมุนไพร ณ เรือนพักปีกใน)` และปุ่ม In-Place Edit ชิดขวา
  - **Dimension 1 (Spatial Layout & Enclosure):** บรรยายสเกลห้องและขอบเขตทางกายภาพ เช่น *"ห้องไม้ 6 เสื่อทาทามิที่ปิดทึบ บานเลื่อนกระดาษฟุซุมะถูกพายุฝนเขย่าจนกระพือสั่น โต๊ะทดลองไม้เตี้ยกลางห้องแคบจนข้อศอกแทบจะชนกันทุกครั้งที่ขยับตัว"*
  - **Dimension 2 (Anchor Points & Proximity Chips):** แสดงจุดปักหลักในฉากเป็นชิปแคปซูลกระจกฝ้าทรงกลมมน (`rounded-full bg-white/[0.05] border border-white/[0.08]`) พร้อมจุดสถานะแดงคาร์ไมน์ เช่น `[ 📍 เบาะรองนั่งริมโต๊ะ (<0.5 ม.) ] [ 📍 ฟูกปูพื้นริมฉากกั้น ] [ 📍 บานเลื่อนลงกลอน ]`
- **Reactive Sync:**
  - เชื่อมต่อกับ Master Scene Selector ของ Card W4 โดยตรง เมื่อผู้ใช้แตะสลับสถานที่ใน W4 ข้อมูลผังห้องและจุดปักหลักของ W3 จะเปลี่ยนตามทันที
- **Direct Manipulation / In-Place Edit Mode:**
  - แก้ไขสถาปัตยกรรมห้องและพิมพ์จุดปักหลักคั่นด้วย • หรือจุลภาค แล้วบันทึกลง `draft.real_locations[activeLocationKey]`

---

#### 🎭 Card W4: เวทีสถานที่และพร็อพ (The Master Stage & Props Ensemble) — 2x2 (`346px × 346px`)
- **Distance Silhouette:** **"The Master Stage & Props Ensemble" (แผงเวทีฉาก 3 มิติ คลังพร็อพโต้ตอบ และระบบสลับสถานที่ Master Scene Selector)**
  - ขนาดมาตรฐาน **2x2 (`346px × 346px`)** เติมเต็มฝั่งขวาของชุด Bento World ให้ได้สัดส่วน 3 เสาสมมาตรเลโก้ (1070px × 346px)
- **Layout & Visual Hierarchy:**
  - **Header Row:** หัวข้อชิดซ้าย **`เวทีสถานที่และพร็อพ`** พร้อมปุ่ม In-Place Edit ชิดขวา
  - **Master Scene Selector Dock:** แถบสลับสถานที่ทรงแคปซูลแนวนอน สโครลเรียบลื่น ไร้แถบเลื่อนกวนสายตา
    - ปุ่มฉากแต่ละปุ่ม: `[ 🌿 ห้องสกัดสมุนไพร ]`, `[ ♨️ บ่อออนเซ็น ]`, `[ 🛖 เพิงหลบฝน ]`
    - ปุ่มเพิ่มฉาก: `[ + เพิ่มฉาก ]` เพื่อสร้างฉากใหม่ได้ทันที
  - **4 Pillars of Scene Atmosphere & Agency (บรรยายเต็ม 100% ไร้การตัดทอน):**
    1. **วัตถุและพร็อพที่หยิบจับได้ (Interactive Props):** รายการวัตถุที่ตัวละครและผู้เล่นสามารถหยิบจับ สัมผัส หรือมีปฏิสัมพันธ์ได้จริง เช่น โกร่งบดยาหินแกรนิต, โหลแก้วเกสรพิษ, กาน้ำชาดินเผา, แว่นตากรอบหนา
    2. **แสงเงาและทัศนวิสัย (Lighting & Shadow):** แสงไฟและเงามืดที่สร้างมิติมุมมอง เช่น แสงตะเกียงน้ำมันส่องสลัว ทอดเงายาวถึงผนังห้อง
    3. **ผัสสะรอบทิศ (3D Sensory Field):** กลิ่น • เสียง • อุณหภูมิผิวสัมผัส นำด้วยสัญลักษณ์ ✦ แดงคาร์ไมน์ เช่น กลิ่นเกสรพิษมึนเมา, เสียงฝนกระหน่ำหลังคาไม้สน, ไอร้อนชื้นแนบเนื้อ
    4. **ไดนามิกการเปลี่ยนฉาก (Dynamic Shift & Environmental Clock):** เหตุการณ์ที่บีบคั้นให้ฉากเปลี่ยนหรือขังตัวละคร เช่น พายุฝนตัดสะพานข้ามหุบเขา ละอองเกสรเริ่มกำเริบ
- **Direct Manipulation / In-Place Edit Mode:**
  - แก้ไขพร็อพ, แสงเงา, ผัสสะ 3 มิติ, และไดนามิกฉากได้โดยตรง พร้อมระบบบันทึกอัตโนมัติ
