...
|                                                                                                                   |
|  [ WIDGET 2: 2x2 (346x346) SINGLE MASTER CARD ]                                                                   |
|  +--------------------------------------------------------+                                                       |
|  | ตัวตนเบื้องลึก (3 มิติ)                          (Edit) |                                                       |
|  | ====================================================== |                                                       |
|  | [ 🛡️ THE MASK ]     หน้ากากทางสังคม                   |                                                       |
|  |  (Cyan Orb 32px)     รุ่นพี่สาวแว่นผู้มีการศึกษา...    |                                                       |
|  | ------------------------------------------------------ |                                                       |
|  | [ ⚡ THE CONFLICT ] จุดขัดแย้งในใจ                     |                                                       |
|  |  (Amber Orb 32px)    การต่อสู้ระหว่างสามัญสำนึก...     |                                                       |
|  | ------------------------------------------------------ |                                                       |
|  | [ ❤️ THE CORE ]     ธาตุแท้ใต้หน้ากาก                  |                                                       |
|  |  (Pink Orb 32px)     นักล่ากามารมณ์จอมวางแผน...        |                                                       |
|  +--------------------------------------------------------+                                                       |
|   (The 3-Tier Glass Chamber — Minimal Apple 2x2 Master Card)                                                      |
|                                                                                                                   |
|  ---------------------------------------------------------------------------------------------------------------  |
|                                                                                                                   |
|  === หมวดที่ 3: พลวัตสเตตัสและเสน่ห์เฉพาะตัว (DYNAMICS & CHARISMA — DUAL 2x2 BENTO SUITE) ===                    |
|                                                                                                                   |
|  [ CARD 3.1: 2x2 (346x346) RADAR ]         [ CARD 3.2: 2x2 (346x346) EQUALIZER & PERKS ]                          |
|  +---------------------------------------+ +--------------------------------------------------------------------+ |
|  | พลวัต 7 แกนหลัก (7 มิติ)        (Edit)| | สเตตัสรอง & เสน่ห์เฉพาะตัว (5 ค่า + 3 เสน่ห์)               (Edit)  | |
|  | ===================================== | | ================================================================== | |
|  |             (การริเริ่ม 8)            | | ความไวต่อสัมผัส 10/10  [=========================================] | |
|  |   (ความซื่อตรง 2)    (การคุมเกม 9)    | | การอ่านคน 9/10         [====================================     ] | |
|  |         \     /\      /               | | ความอดทน 8/10          [================================         ] | |
|  | (การแสดงออก 4)  +  (เข้าหาทางกาย 8)   | | ความหนาหน้ากาก 8/10    [================================         ] | |
|  |         /     \/      \               | | ความมั่นคงทางอารมณ์ 4/10 [================                        ] | |
|  |  (ความเป็นทางการ 9)  (ความขี้เล่น 7)   | | ------------------------------------------------------------------ | |
|  | ------------------------------------- | | เสน่ห์เฉพาะตัว (SIGNATURE PERKS):                                  | |
|  | บุคลิกภาพเด่น: คุมเกม 9 • ทางการ 9... | | [ ✦ Thermal Shock ] [ ✦ ตรรกะรีดพิษ ] [ ✦ สวิตช์ขาแว่น ]           | |
|  +---------------------------------------+ +--------------------------------------------------------------------+ |
|   (The Heptagon Spider Web Radar)           (The Linear Equalizer Gauges & Apple Dark Pill Chips)                 |
+-------------------------------------------------------------------------------------------------------------------+
```
...
#### 🕸️ Card 3.1: พลวัต 7 แกนหลัก (The 7-Axis Dynamics Radar) — 2x2 (`346px × 346px`)
- **Distance Silhouette:** **"The Heptagon Spider Web" (แผนภูมิใยแมงมุมเรขาคณิต 7 เหลี่ยม)**
  ...
  - ตาข่ายใยแมงมุม 7 เหลี่ยมซ้อนกัน 5 วง (สเกล 2, 4, 6, 8, 10) พร้อม 7 แกนฉายออกจากจุดศูนย์กลาง
...
- **Typography & Vertex Nodes:**
  - ป้ายกำกับ 7 ทิศทางรอบนอก: ภาษาไทย + ตัวเลขคะแนนสีแดงคาร์ไมน์ `#EF264C` + ซับไตเติลภาษาอังกฤษตัวบาง
  - จุดพิกัด Vertex ดวงแก้วสีแดงคาร์ไมน์แกนขาวเรืองแสงนวลตา
  - แถบสรุปบุคลิกภาพเด่นทรงแคปซูลด้านล่าง
- **In-Place Stepper Editor:**
  - ปุ่มดินสอขวาบน แตะเพื่อสลับเข้าโหมดปรับคะแนน `[-] [ค่า] [+] /10` ได้สะดวกรวดเร็ว
